...
\(T_0=450\) K, LAMMPS switches between MTACE and a species-resolved Einstein
crystal,

\[
U_\lambda=(1-\lambda)U_{\mathrm{MLIP}}+\lambda U_{\mathrm{Ein}},
\qquad
...
\[
F_{\mathrm{MLIP}}(T_0,V_0)=F_{\mathrm{Ein}}(T_0,V_0)
+\int_0^1\!d\lambda\,
\left\langle U_{\mathrm{MLIP}}-U_{\mathrm{Ein}}\right\rangle_\lambda .
\]
...
\(H=U_{\mathrm{MLIP}}+K+P_{\mathrm{ext}}V\). In particular, the analysis does
